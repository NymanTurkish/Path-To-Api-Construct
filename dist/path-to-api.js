    ...
    constructor(scope, id, props) {
        ...
        this.getLambdaEntryPoint = (props, pathToMethod, entryPoint) => {
            if (props.isLocalStack) {
                ...
                return {
                    code: cdk.aws_lambda.Code.fromBucket(this.localstackHotReloadBucket, props.tsApiOutputFolder),
                    // handler: path.join(pathToMethod, `${entryPoint}.handler`),
                    handler: path.join(pathToMethod.substring(props.tsApiOutputFolder.length + 1 /* +1 to remove leading / */), `${entryPoint}.handler`)
                };
            }
            else {
                return {
        ...
        this.addMethod = (type, resource, pathToMethod, config, methodName, props) => __awaiter(this, void 0, void 0, function* () {
            let methodProps = Object.assign(Object.assign(Object.assign({ runtime: lambda.Runtime.NODEJS_18_X, environment: this.environment, logRetention: cdk.aws_logs.RetentionDays.ONE_MONTH, functionName: `${cdk.Stack.of(this).stackName}-${methodName}`, timeout: cdk.Duration.seconds(30), memorySize: this.lambdaMemorySize }, props.functionProps), config.functionProps), this.getLambdaEntryPoint(props, pathToMethod, type.toLowerCase()));
